...
class StudiesControllerTest < ActionController::TestCase
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post :create, study: { ECTS: @study.ECTS, degree: @study.degree, field: @study.field, name: @study.name }
    end
  ...
  test "should update study" do
    patch :update, id: @study, study: { ECTS: @study.ECTS, degree: @study.degree, field: @study.field, name: @study.name }
    assert_redirected_to study_path(assigns(:study))
  end
